...
class AquaticGrouping(object):
    ...
    def getParameterInfo(self):
        in_points = arcpy.Parameter(
            displayName = "Input points for separation distance analysis",
            name = "in_points",
            datatype = "GPFeatureLayer",
            parameterType = "Optional",
            direction = "Input")
        ...
        in_lines = arcpy.Parameter(
            displayName = "Input lines for separation distance analysis",
            name = "in_lines",
            datatype = "GPFeatureLayer",
            parameterType = "Optional",
            direction = "Input")
        ...
        in_poly = arcpy.Parameter(
            displayName = "Input polygons for separation analysis",
            name = "in_poly",
            datatype = "GPFeatureLayer",
            parameterType = "Optional",
            direction = "Input")
