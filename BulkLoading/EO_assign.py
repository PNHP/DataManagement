...
class Toolbox(object):
    def __init__(self):
        ...
        self.tools = [TerrestrialGrouping]
...
class TerrestrialGrouping(object):
    ...
    def getParameterInfo(self):
        ...
        objectid_field = arcpy.Parameter(
            displayName = "OBJECTID Field",
            name = "objectid_field",
            datatype = "Field",
            parameterType = "Required",
            direction = "Input")
        objectid_field.parameterDependencies = [in_data.name]
        ...
        params = [in_data,objectid_field,lu_separation,eo_reps,eo_sourcept,eo_sourceln,eo_sourcepy]
        return params
    ...
    def execute(self, params, messages):
        ...
        objectid_field = params[1].valueAsText
