...
class TerrestrialGrouping(object):
    ...
    def getParameterInfo(self):
        in_points = arcpy.Parameter(
            displayName = "First input dataset for separation distance analysis (points, lines, or polygons)",
            name = "in_points",
        ...
        in_lines = arcpy.Parameter(
            displayName = "Second input dataset for separation distance analysis (points, lines, or polygons)",
            name = "in_lines",
            datatype = "GPFeatureLayer",
        ...
        in_poly = arcpy.Parameter(
            displayName = "Third input dataset for separation distance analysis (points, lines, or polygons)",
            name = "in_poly",
            datatype = "GPFeatureLayer",
            parameterType = "Optional",
            direction = "Input")
        ...
        eo_sourcept = arcpy.Parameter(
            displayName = "Existing Source Feature Point Layer",
            name = "eo_sourcept",
            datatype = "GPFeatureLayer",
            parameterType = "Required",
            direction = "Input")
        ...
        eo_sourceln = arcpy.Parameter(
            displayName = "Existing Source Feature Line Layer",
            name = "eo_sourceln",
            datatype = "GPFeatureLayer",
            parameterType = "Required",
            direction = "Input")
        ...
        eo_sourcepy = arcpy.Parameter(
            displayName = "Existing Source Feature Polygon Layer",
            name = "eo_sourcepy",
            datatype = "GPFeatureLayer",
            parameterType = "Required",
            direction = "Input")
    ...
    def execute(self, params, messages):
        ...
        #add temporary join id to original input datasets and prepare single temporary fc from input datasets
        data_in = []
        data_out = []
        if in_points:
        ...
        #set species query format based on type of value
        ...
        #set word index to 1 to start assignment
        word_index = 1
        observation_num = 1
...
class AquaticGrouping(object):
    ...
    def execute(self, params, messages):
        ...
        #add temporary join id to original input datasets and combine datasets into one
