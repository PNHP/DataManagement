...
##            parameterType = "Optional",
##            direction = "Input")
##        lu_class.parameterDependencies = [in_points.name]
...
##        lu_class.parameterDependencies = [in_points.name]
        ...
        params = [in_points,in_lines,in_poly,lu_separation,eo_reps,eo_id_field,eo_sourcept,eo_sourceln,eo_sourcepy,sf_id_field]
        return params
    ...
    def execute(self, params, messages):
        ...
        lu_separation = params[3].valueAsText
        eo_reps = params[4].valueAsText
        eo_id_field = params[5].valueAsText
        eo_sourcept = params[6].valueAsText
        eo_sourceln = params[7].valueAsText
        eo_sourcepy = params[8].valueAsText
        sf_id_field = params[9].valueAsText
        ...
        search_fields = [objectid_field, "EO_ID", "EO_NEW", "SNAME", lu_separation]
##        if lu_class:
...
##                        lu_class_value = row[5]
                    ...
                    arcpy.SelectLayerByAttribute_management(eo_reps, 'NEW_SELECTION', "SNAME='{}'".format(sname))
##                    if lu_class:
##                        arcpy.SelectLayerByAttribute_management(eo_reps,'SUBSET_SELECTION',"{}={}".format(lu_class,lu_class_value))
                    ...
                    if selection_num is not u'':
                        ...
                        while(countBefore!=countAfter):
                            ...
                            arcpy.SelectLayerByAttribute_management(data_lyr, "SUBSET_SELECTION", "SNAME='{}'".format(sname))
##                            if lu_class:
##                                arcpy.SelectLayerByAttribute_management(data_lyr,"SUBSET_SELECTION","{}={}".format(lu_class,lu_class_value))
...
##                                arcpy.SelectLayerByAttribute_management(data_lyr,"SUBSET_SELECTION","{}={}".format(lu_class,lu_class_value))
        ...
        observation_num = 1
        search_fields = [objectid_field, "SF_ID", "SF_NEW", "SNAME"]
##        if lu_class:
##            search_fields.append(lu_class)
        with arcpy.da.SearchCursor(data_lyr, search_fields) as cursor:
            for row in cursor:
                ...
                if row[2] != None and (row[1] != None or row[1] != 0):
                    ...
                    arcpy.SelectLayerByAttribute_management(data_lyr, "NEW_SELECTION", "{}={}".format(objectid_field, objectid))
                    arcpy.SelectLayerByAttribute_management(sf_lyr, 'NEW_SELECTION', "SNAME='{}'".format(sname))
