...
class CSVQueryExport(object):
    ...
    def getParameterInfo(self):
        ...
        params = [export_lyr, export_query_fld, csv_tbl, csv_field, output_fc]
        return params
    ...
    def execute(self, params, messages):
        ...
        merge = pd.merge(df,output_df[['exported_features']],left_on=export_query_field,right_on='exported_features',how='outer')
